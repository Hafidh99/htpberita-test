...
<!-- Detail Berita -->
    <div class="flex flex-col px-4 lg:px-14 mt-10">
        ...
        <!-- Berita Utama -->
        <div class="lg:w-8/12">
            <img src="{{ asset('storage/' . $news->thumbnail) }}" alt="MotoGP" class="w-full max-h-96 rounded-xl object-cover" style="height: 320px ; width: 500px; object-fit: cover;">
            {!! $news->content !!}
        </div>
        <!-- Berita Terbaru -->
        <div class="lg:w-4/12 flex flex-col gap-10">
            ...
            <div class=" gap-5 flex flex-col">
                ...
                <div class="flex gap-3 border border-slate-300 hover:border-primary p-3 rounded-xl">
                    ...
                    <img src="{{ asset('storage/' . $new->thumbnail) }}" alt="" class="max-h-36 rounded-xl object-cover" style="width: 150px; height: 100px;">
                    <div class="">
